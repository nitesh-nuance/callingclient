...
export declare class CallClient {
    ...
    /**
     * Disposes this CallClient which also disposes of the associated device manager and associated call agent.
     */
    dispose(): Promise<void>;
    ...
    private sendCallClientOperationEvent;
    private hangupCalls;
...
export declare interface CallCommon extends Disposable {
    ...
    resume(): Promise<void>;
    /**
     * - Start sending screen sharing stream in a call.
     * - If localVideoStream is provided, it will be used as the screen sharing stream.
     * - Otherwise, the browser will prompt to select the screen, app, or browser tab.
     * - The iOS or Android browser only supports start screen sharing stream with a raw video stream
...
export declare class LocalAudioStream {
     ...
     * @param options - Options for the local audio stream.
     * @public
     */
    constructor(source: AudioDeviceInfo, options?: LocalAudioStreamOptions);
    constructor(source: MediaStream, options?: LocalAudioStreamOptions);
    /**
...
/**
 * Local audio stream options.
 */
export declare interface LocalAudioStreamOptions {
    /**
     * If true, the local audio stream will be disposed when the call ends. Default value is true.
     */
    autoDisposeOnCallEnd?: boolean;
}
...
export declare class LocalVideoStream {
     ...
     * @param options - Options for the local video stream.
     * @public
     */
    constructor(source: VideoDeviceInfo, options?: LocalVideoStreamOptions);
    constructor(source: MediaStream, options?: LocalVideoStreamOptions);
    /**
...
/**
 * Local video stream options.
 */
export declare interface LocalVideoStreamOptions {
    /**
     * If true, the local video stream will be disposed when the call ends. Default value is true.
     */
    autoDisposeOnCallEnd?: boolean;
}
